...
export type ChipTone = 'primary' | 'idle' | 'info' | 'success' | 'warning' | 'danger'
...
const toneStyles: Record<ChipTone, string> = {
  primary: 'border-brand-500/60 bg-brand-500/10 text-brand-200',
...
export function Chip({
  ...
  const baseClass = [
    'inline-flex items-center justify-center rounded-full px-3 py-1 text-xs font-semibold leading-none transition-colors duration-150',
